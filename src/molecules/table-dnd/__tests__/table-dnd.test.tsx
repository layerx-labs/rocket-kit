...
describe('TableDnD', () => {
  it('renders', () => {
    ...
    const { asFragment } = render(
      <TableDnD<CellData> options={options} values={rows} actions={actions} />
    );
  ...
  it('renders 5 rows', () => {
    ...
    render(<TableDnD<CellData> options={options} values={rows} />);
  ...
  it('renders empty table with empty data', () => {
    ...
    render(<TableDnD<CellData> options={options} values={rows} showEmpty />);
